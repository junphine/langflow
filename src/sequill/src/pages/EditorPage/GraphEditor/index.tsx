      ...
      >
        ...
        {nodeSelected && (
          <NodeModal
            ...
            isValidID={isValidID}
            variablesGet={() => parentTravelVariables(nodes,edges,variables,nodeSelected) }
            story={story}
          />
        )}
        {edgeSelected && (
        ...
        {editCharacters &&(
          <CharactersModal
            characters={story.graph.characters}
            applyChanges={applyChanges}       
            onClose={()=> setEditCharacters(false)}
          ></CharactersModal>
        )}
        {children}
      </ReactFlow>
