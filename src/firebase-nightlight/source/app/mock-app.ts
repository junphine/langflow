...
import { MockDatabase, MockDatabaseContent, MockDataSnapshot, MockRef, MockValue, MockComposite } from "../database";
...
export class MockApp implements firebase.app.App {
    ...
    private initializeOptions_: any;
    private storageOptions_: Object | undefined;
    ...
    constructor(options: MockAppOptions) {
        ...
        this.storageOptions_ = options.storage;
        this.name_ = options.name;

        this.auth_ = new MockAuth({
            app: this,
            identities: options.identities,
            authURL: this.initializeOptions_['authURL'],
        });
    ...
    storage(url?: string): firebase.storage.Storage {
        ...
        return new MockStorage({
            app: this,
            url: url,
            bucket: this.initializeOptions_['storageBucket'],
            ... this.storageOptions_
        });
    }
        ...
        lodash.each(this.databaseEmitters_.shared, (sharedEmitter, sharedEmitterJsonPath: string) => {
            ...
            if ((typeof value === "object") && (typeof previousValue === "object")) {
                ...
                lodash.each(lodash.intersectionWith(
                    ...
                    if ((value as MockComposite)[changedKey] !== (previousValue as MockComposite)[changedKey]) {
