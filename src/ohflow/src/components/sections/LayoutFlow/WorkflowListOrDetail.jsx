...
import WorkflowLibrary from "../WorkflowLibrary/WorkflowLibrary";
//TODO make this zoom into a single workflow to support detail
export default function WorkflowListOrDetail(props) {
  ...
  return (
    <>
      ...
      {!active ? <WorkflowLibrary onSelect={onSelectFlow} onUpvote={onUpvoteFlow} /> : null}
    </>
  );
}
