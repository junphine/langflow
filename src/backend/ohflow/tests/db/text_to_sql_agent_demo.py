...
#db = IgniteDatabase.from_uri(f"ignite://127.0.0.1:10801/PRE?metaServerURL={configServer}&metaAccessToken={configToken}",schema='PRE',
#                             sample_rows_in_table_info=0,include_tables=table_names_to_use)
...
response = agent.invoke({"input": "药品“痤螨液”的包装方式是什么?"})
print('resp:'+str(response))
