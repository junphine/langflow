...
from langflow.interface.embeddings.custom import CUSTOM_EMBEDDING
...
CUSTOM_NODES = {**CUSTOM_AGENTS, **CUSTOM_CHAINS, **CUSTOM_EMBEDDING}  # type: ignore
embedding_type_to_cls_dict.update(CUSTOM_EMBEDDING)
